[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/zino-hofmann/pi-camera-connect/master/LICENSE)
[![npm](https://img.shields.io/npm/v/pi-camera-connect.svg)](https://www.npmjs.com/package/@zino-hofmann/pi-camera-connect)

# Pi Camera Connect - for NodeJS

This is a fork from [`pi-camera-connect`](https://github.com/launchcodedev/pi-camera-connect).
...
- `iso: number` - _Default: Auto_
- `exposureCompensation: number` - _Default: `0`_
- [`exposureMode: ExposureMode`](#exposuremode) - _Default: Auto_
- [`awbMode: AwbMode`](#awbmode) - _Default: Auto_
- `analogGain: number` - _Default: 0_
- `digitalGain: number` - _Default: 0_
...
- [`rotation: Rotation`](#rotation) - _Default: `Rotation.Rotate0`_
- [`flip: Flip`](#flip) - _Default: `Flip.None`_
- `bitRate: number` - _Default: 17 Mbps_
